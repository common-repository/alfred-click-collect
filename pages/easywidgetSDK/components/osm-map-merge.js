...
const closeModalSelection = () => {
  ...
  if (!isEmptyObject(callBackObject)) {
    ...
    modal.classList.remove("alfred-woo-plugin-showModal");
    location.reload();
  }
};
...
locDataObservable.subscribe({
  next: (result) => {
    ...
    Object.assign(logo, {
      ...
      //src: "https://alfred.delivery//////wp-content/uploads/2018/10/alfred24-logo_gradient_Small.png",
  ...
  complete: () => {
    ...
    if (typeFilterData.includes("alfred24 Point")) {
      moveItem(
        typeFilterData.indexOf("alfred24 Point"),
        typeFilterData.length - 5,
        typeFilterData
      );
    }
    if (typeFilterData.includes("alfred24 Locker")) {
      moveItem(
        typeFilterData.indexOf("alfred24 Locker"),
    ...
    if (r === null) {
      ...
      if (_locale === "en") {
        noResultText.innerHTML =
          "The location you have searched for does not have any alfred24 Locations available";
      } else if (_locale === "zh") {
